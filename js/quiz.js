	...
	var app = angular.module('myQuiz',[]);
        ...
        app.controller('QuizController',['$scope','$http','$sce',function($scope,$http,$sce){
            ...
            $scope.createShareLinks = function(percentage){
                ...
                var emailLink = '<a class="btn email" href="mailto:?subject=Try to beat my quiz score!&amp;body=I scored a '+percentage+'% on this quiz about Saturn. Try to beat my score at '+url+'">Email a freind</a>';
